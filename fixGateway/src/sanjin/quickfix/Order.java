...
//        ID = generateID();
    ...
    public static synchronized String generateID() {
        return TraderInterface.get().brokerId + Long.toString(System.currentTimeMillis() + (nextID++));
    }
	...
	public String toString() {
		return "Order [sessionID=" + sessionID + ", symbol=" + symbol + ", quantity=" + quantity + ", open=" + open
				+ ", executed=" + executed + ", side=" + side + ", type=" + type + ", tif=" + tif + ", limit=" + limit
				+ ", stop=" + stop + ", avgPx=" + avgPx + ", rejected=" + rejected + ", canceled=" + canceled
				+ ", finished=" + finished + ", isNew=" + isNew + ", message=" + message + ", ID=" + ID
				+ ", clientOrderID=" + clientOrderID + ", originalID=" + originalID + ", orderTime=" + orderTime
