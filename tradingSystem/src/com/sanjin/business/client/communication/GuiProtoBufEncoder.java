...
public class GuiProtoBufEncoder extends ProtocolEncoderAdapter {
	private final Charset charset;

	public GuiProtoBufEncoder(Charset charset) {
	...
	public void encode(IoSession session, Object message,
		...
		SanjinClientMessage m = (SanjinClientMessage) message;
