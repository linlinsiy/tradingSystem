...
class SessionRejectReasonText extends SessionRejectReason {
    ...
    static {
        ...
        rejectReasonText.put(INVALID_MESSAGE_TYPE, "Invalid MsgType");
        rejectReasonText.put(SEVERAL_TIMES_IN_SAME_TAG, "Tag appears more than once");
        rejectReasonText.put(ORDERED_TAG_ORDER_ERROR, "Tag specified out of required order");
        rejectReasonText.put(REPEAT_TAG_TIME_ERROR, "Incorrect NumInGroup count for repeating group");
        rejectReasonText.put(REPEAT_TAG_ORDER_ERROR, "Out of order repeating group members");
    }
