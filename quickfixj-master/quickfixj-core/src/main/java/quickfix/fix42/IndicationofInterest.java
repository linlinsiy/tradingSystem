...
public class IndicationofInterest extends Message {
	...
	public IndicationofInterest(IOIID iOIid, quickfix.field.IOITransType iOITransType, quickfix.field.Symbol symbol, quickfix.field.Side side, quickfix.field.IOIShares iOIShares) {
		this();
		setField(iOIid);
