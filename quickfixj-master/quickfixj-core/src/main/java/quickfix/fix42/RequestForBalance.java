...
public class RequestForBalance extends Message {

	static final long serialVersionUID = 20050617;
	public static final String MSGTYPE = "URB";
	

	public RequestForBalance() {
		super();
		getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
	}
	
	public RequestForBalance(quickfix.field.Account account, quickfix.field.RequestID requestID) {
		this();
		setField(account);
		setField(requestID);
	}
