...
public class MarginRateStatusRequest extends Message {

	static final long serialVersionUID = 20050617;
	public static final String MSGTYPE = "UF018";
	

	public MarginRateStatusRequest() {
		super();
		getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
	}
	
	public MarginRateStatusRequest(quickfix.field.RequestID requestID, quickfix.field.ClientID clientID, quickfix.field.VarietyCode varietyCode, quickfix.field.SecurityExchange securityExchange) {
		this();
		setField(requestID);
		setField(clientID);
