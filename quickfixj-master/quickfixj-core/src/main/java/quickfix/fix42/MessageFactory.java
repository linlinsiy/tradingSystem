...
public class MessageFactory implements quickfix.MessageFactory {
	...
	public Message create(String beginString, String msgType) {
		...
		switch (msgType) {
			...
			case quickfix.fix42.RequestForPosition.MSGTYPE:
				return new quickfix.fix42.RequestForPosition();
	
			case quickfix.fix42.PositionReport.MSGTYPE:
				return new quickfix.fix42.PositionReport();
	
			case quickfix.fix42.RequestForBalance.MSGTYPE:
				return new quickfix.fix42.RequestForBalance();
	
			case quickfix.fix42.BalanceReport.MSGTYPE:
				return new quickfix.fix42.BalanceReport();
	
			case quickfix.fix42.UserLogonRequest.MSGTYPE:
				return new quickfix.fix42.UserLogonRequest();
	
			case quickfix.fix42.UserLogonResponse.MSGTYPE:
				return new quickfix.fix42.UserLogonResponse();
	
			case quickfix.fix42.UserLogoutRequest.MSGTYPE:
				return new quickfix.fix42.UserLogoutRequest();
	
			case quickfix.fix42.UserLogoutResponse.MSGTYPE:
				return new quickfix.fix42.UserLogoutResponse();
	
			case quickfix.fix42.UserChangePassWdRequest.MSGTYPE:
				return new quickfix.fix42.UserChangePassWdRequest();
	
			case quickfix.fix42.UserChangePassWdResponse.MSGTYPE:
				return new quickfix.fix42.UserChangePassWdResponse();
	
			case quickfix.fix42.PositionStatusRequest.MSGTYPE:
				return new quickfix.fix42.PositionStatusRequest();
	
			case quickfix.fix42.PositionStatusResponse.MSGTYPE:
				return new quickfix.fix42.PositionStatusResponse();
	
			case quickfix.fix42.MaxOperationPositionStatusRequest.MSGTYPE:
				return new quickfix.fix42.MaxOperationPositionStatusRequest();
	
			case quickfix.fix42.MaxOperationPositionStatusResponse.MSGTYPE:
				return new quickfix.fix42.MaxOperationPositionStatusResponse();
	
			case quickfix.fix42.AllOrdersStatusRequest.MSGTYPE:
				return new quickfix.fix42.AllOrdersStatusRequest();
	
			case quickfix.fix42.AllOrdersStatusResponse.MSGTYPE:
				return new quickfix.fix42.AllOrdersStatusResponse();
	
			case quickfix.fix42.SettlementResultStatusRequest.MSGTYPE:
				return new quickfix.fix42.SettlementResultStatusRequest();
	
			case quickfix.fix42.SettlementResultStatusResponse.MSGTYPE:
				return new quickfix.fix42.SettlementResultStatusResponse();
	
			case quickfix.fix42.SettlementResultComfirmRequest.MSGTYPE:
				return new quickfix.fix42.SettlementResultComfirmRequest();
	
			case quickfix.fix42.SettlementResultComfirmResponse.MSGTYPE:
				return new quickfix.fix42.SettlementResultComfirmResponse();
	
			case quickfix.fix42.SettlementResultComfirmStatusRequest.MSGTYPE:
				return new quickfix.fix42.SettlementResultComfirmStatusRequest();
	
			case quickfix.fix42.MarginRateStatusRequest.MSGTYPE:
				return new quickfix.fix42.MarginRateStatusRequest();
	
			case quickfix.fix42.MarginRateStatusResponse.MSGTYPE:
				return new quickfix.fix42.MarginRateStatusResponse();
	
			case quickfix.fix42.CommissionRateStatusRequest.MSGTYPE:
				return new quickfix.fix42.CommissionRateStatusRequest();
	
			case quickfix.fix42.CommissionRateStatusResponse.MSGTYPE:
				return new quickfix.fix42.CommissionRateStatusResponse();
	
			case quickfix.fix42.CustomerCapitalStatusRequest.MSGTYPE:
				return new quickfix.fix42.CustomerCapitalStatusRequest();
	
			case quickfix.fix42.CustomerCapitalStatusResponse.MSGTYPE:
				return new quickfix.fix42.CustomerCapitalStatusResponse();
	
			case quickfix.fix42.AgreementStatusRequest.MSGTYPE:
				return new quickfix.fix42.AgreementStatusRequest();
	
			case quickfix.fix42.AgreementStatusResponse.MSGTYPE:
				return new quickfix.fix42.AgreementStatusResponse();
	
			case quickfix.fix42.MarketDataStatusRequest.MSGTYPE:
				return new quickfix.fix42.MarketDataStatusRequest();
