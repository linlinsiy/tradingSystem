...
public class SettlementResultStatusRequest extends Message {

	static final long serialVersionUID = 20050617;
	public static final String MSGTYPE = "UF013";
	

	public SettlementResultStatusRequest() {
		super();
		getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
	}
	
	public SettlementResultStatusRequest(quickfix.field.RequestID requestID, quickfix.field.ClientID clientID, quickfix.field.SettlementDate settlementDate, quickfix.field.SecurityExchange securityExchange) {
		this();
		setField(requestID);
		setField(clientID);
