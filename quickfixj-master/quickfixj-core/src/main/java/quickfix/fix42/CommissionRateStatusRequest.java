...
public class CommissionRateStatusRequest extends Message {

	static final long serialVersionUID = 20050617;
	public static final String MSGTYPE = "UF020";
	

	public CommissionRateStatusRequest() {
		super();
		getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
	}
	
	public CommissionRateStatusRequest(quickfix.field.RequestID requestID, quickfix.field.ClientID clientID, quickfix.field.SecurityExchange securityExchange) {
		this();
		setField(requestID);
		setField(clientID);
