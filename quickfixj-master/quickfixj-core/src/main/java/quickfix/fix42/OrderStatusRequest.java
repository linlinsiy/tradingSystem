...
public class OrderStatusRequest extends Message {
	...
	public OrderStatusRequest(quickfix.field.ClOrdID clOrdID, quickfix.field.Symbol symbol, quickfix.field.SecurityType securityType, quickfix.field.Side side) {
		this();
		setField(clOrdID);
		setField(symbol);
