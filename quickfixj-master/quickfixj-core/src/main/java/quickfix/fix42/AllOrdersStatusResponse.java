...
public class AllOrdersStatusResponse extends Message {

	static final long serialVersionUID = 20050617;
	public static final String MSGTYPE = "UF012";
	

	public AllOrdersStatusResponse() {
		super();
		getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
	}
	
	public AllOrdersStatusResponse(quickfix.field.RequestID requestID, quickfix.field.ClientID clientID, quickfix.field.Account account, quickfix.field.SecurityExchange securityExchange, quickfix.field.ClOrdID clOrdID, quickfix.field.OrdStatus ordStatus, quickfix.field.OpenClose openClose, quickfix.field.Side side, quickfix.field.OrderQty orderQty, quickfix.field.OrdType ordType, quickfix.field.LeavesQty leavesQty, quickfix.field.CumQty cumQty, quickfix.field.AvgPx avgPx) {
		this();
		setField(requestID);
		setField(clientID);
		setField(account);
