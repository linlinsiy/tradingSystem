...
public class ExecutionReport extends Message {
	...
	public void set(quickfix.field.OrderEntryTime value) {
		setField(value);
	}

	public quickfix.field.OrderEntryTime get(quickfix.field.OrderEntryTime value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.OrderEntryTime getOrderEntryTime() throws FieldNotFound {
		return get(new quickfix.field.OrderEntryTime());
	}

	public boolean isSet(quickfix.field.OrderEntryTime field) {
		return isSetField(field);
	}

	public boolean isSetOrderEntryTime() {
		return isSetField(8500);
	}

	public void set(quickfix.field.DeclarationID value) {
		setField(value);
	}

	public quickfix.field.DeclarationID get(quickfix.field.DeclarationID value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.DeclarationID getDeclarationID() throws FieldNotFound {
		return get(new quickfix.field.DeclarationID());
	}

	public boolean isSet(quickfix.field.DeclarationID field) {
		return isSetField(field);
	}

	public boolean isSetDeclarationID() {
		return isSetField(8093);
	}
	...
	public boolean isSetTradeID() {
		return isSetField(8094);
	}

	public void set(quickfix.field.ArrivalPrice value) {
		setField(value);
	}

	public quickfix.field.ArrivalPrice get(quickfix.field.ArrivalPrice value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.ArrivalPrice getArrivalPrice() throws FieldNotFound {
		return get(new quickfix.field.ArrivalPrice());
	}

	public boolean isSet(quickfix.field.ArrivalPrice field) {
		return isSetField(field);
	}

	public boolean isSetArrivalPrice() {
		return isSetField(3111);
	}

	public void set(quickfix.field.TargetProgress value) {
		setField(value);
	}

	public quickfix.field.TargetProgress get(quickfix.field.TargetProgress value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.TargetProgress getTargetProgress() throws FieldNotFound {
		return get(new quickfix.field.TargetProgress());
	}

	public boolean isSet(quickfix.field.TargetProgress field) {
		return isSetField(field);
	}

	public boolean isSetTargetProgress() {
		return isSetField(3102);
	}

	public void set(quickfix.field.VWapMarketPrice value) {
		setField(value);
	}

	public quickfix.field.VWapMarketPrice get(quickfix.field.VWapMarketPrice value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.VWapMarketPrice getVWapMarketPrice() throws FieldNotFound {
		return get(new quickfix.field.VWapMarketPrice());
	}

	public boolean isSet(quickfix.field.VWapMarketPrice field) {
		return isSetField(field);
	}

	public boolean isSetVWapMarketPrice() {
		return isSetField(3109);
	}

	public void set(quickfix.field.NotificationReason value) {
		setField(value);
	}

	public quickfix.field.NotificationReason get(quickfix.field.NotificationReason value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.NotificationReason getNotificationReason() throws FieldNotFound {
		return get(new quickfix.field.NotificationReason());
	}

	public boolean isSet(quickfix.field.NotificationReason field) {
		return isSetField(field);
	}

	public boolean isSetNotificationReason() {
		return isSetField(3108);
	}
	...
	public void set(quickfix.field.RealParticipationRate value) {
		setField(value);
	}

	public quickfix.field.RealParticipationRate get(quickfix.field.RealParticipationRate value) throws FieldNotFound {
		getField(value);
		return value;
	}

	public quickfix.field.RealParticipationRate getRealParticipationRate() throws FieldNotFound {
		return get(new quickfix.field.RealParticipationRate());
	}

	public boolean isSet(quickfix.field.RealParticipationRate field) {
		return isSetField(field);
	}

	public boolean isSetRealParticipationRate() {
		return isSetField(3110);
	}
