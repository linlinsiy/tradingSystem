...
public class CustomerCapitalStatusRequest extends Message {

	static final long serialVersionUID = 20050617;
	public static final String MSGTYPE = "UF022";
	

	public CustomerCapitalStatusRequest() {
		super();
		getHeader().setField(new quickfix.field.MsgType(MSGTYPE));
	}
	
	public CustomerCapitalStatusRequest(quickfix.field.RequestID requestID, quickfix.field.ClientID clientID) {
		this();
		setField(requestID);
		setField(clientID);
	}
