...
public class SessionRejectReason extends IntField {
	...
	public static final int SEVERAL_TIMES_IN_SAME_TAG = 13;
	public static final int ORDERED_TAG_ORDER_ERROR = 14;
	public static final int REPEAT_TAG_ORDER_ERROR = 15;
	public static final int REPEAT_TAG_TIME_ERROR = 16;
	public static final int NON_DATA_TAG_APPEAR_DEFINE = 17;
